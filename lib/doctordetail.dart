                ...
                Container(
                  ...
                  child: TabBar(
                    ...
                    tabs: [
                      Tab(
                        child: Text(
                          getTranslated(context, doctorDetail_tab1_title)
                              .toString(),
                      ...
                      Tab(
                        child: Text(
                          getTranslated(context, doctorDetail_tab2_title)
                              .toString(),
                          textAlign: TextAlign.center,
                        ),
                      ),
                      Tab(
                        child: Text(
                          getTranslated(context, doctorDetail_tab3_title)
                              .toString(),
                          textAlign: TextAlign.center,
                        ),
                      ),
                      ...
                      children: [
                            ...
                            children: [
                              Center(
                                child: Container(
                                  ...
                                  child: Text(
                                    getTranslated(
                                            context, doctorDetail_personalBio)
                                        .toString(),
                                    style: TextStyle(
                                        fontSize: width * 0.04,
                                        color: Palette.dark_blue),
                              ...
                              Center(
                                child: Container(
                                  ...
                                  child: Text(
                                    '$desc',
                                    style: TextStyle(
                                        fontSize: 13, color: Palette.grey),
                              ...
                              Center(
                                child: Container(
                                  ...
                                  child: Text(
                                    getTranslated(
                                            context, doctorDetail_education)
                                        .toString(),
                                    style: TextStyle(
                                        fontSize: width * 0.04,
                                        color: Palette.dark_blue),
                              ...
                              Center(
                                child: Container(
                                  ...
                                  child: Text(
                                    getTranslated(
                                            context, doctorDetail_certificate)
                                        .toString(),
                                    style: TextStyle(
                                        fontSize: width * 0.04,
                                        color: Palette.dark_blue),
                        ...
                        reviews.length != 0
                            ...
                            : Container(
                                ...
                                child: Text(
                                  getTranslated(context, doctorDetail_noReview)
                                      .toString(),
                                  style: TextStyle(
                                      fontSize: width * 0.04,
                                      color: Palette.dark_blue),
