...
class _BookAppointmentState extends State<BookAppointment> {
                      ...
                      Container(
                        child: Text(
                          getTranslated(
                              ...
                              .toString(),
                          style: TextStyle(
                              fontSize: width * 0.045, color: Palette.blue),
                        ),
                      ),
                      Container(
                        child: Text(
  ...
  beginPayment() async {
    final Flutterwave flutterwave = Flutterwave.forUIPayment(
      ...
      // encryptionKey: "FLWSECK_TESTac1b485a8f5a",
      encryptionKey: SharedPreferenceHelper.getString(
          Preferences.flutterWave_encryption_key)!,
      publicKey: SharedPreferenceHelper.getString(Preferences.flutterWave_key)!,
      // publicKey: "FLWPUBK_TEST-4937240a52d479c2a57a187a8e1f65ec-X",
      currency: SharedPreferenceHelper.getString(Preferences.currency_code)!,
      // this.currency,
      amount: "$newAppointmentFees" != "0.0"
          ? '$newAppointmentFees'
