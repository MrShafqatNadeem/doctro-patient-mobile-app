                      ...
                      child: ListView(
                        ...
                        children: [
                          GridView.builder(
                            ...
                            scrollDirection: Axis.vertical,
                            gridDelegate:
                                SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, mainAxisSpacing: 5, childAspectRatio: 0.85),
                      ...
                      child: ListView(
                        ...
                        children: [
                          GridView.builder(
                            ...
                            scrollDirection: Axis.vertical,
                            gridDelegate:
                                SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, mainAxisSpacing: 0, childAspectRatio: 0.85),
                            itemBuilder: (context, index) {
                              favoriteDoctor.clear();
