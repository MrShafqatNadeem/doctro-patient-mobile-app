...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    //                                                       style: TextStyle(
    //                                                           fontSize: 16, color: Palette.dark_blue, fontWeight: FontWeight.bold),
    //                                                       textAlign: TextAlign.center,
    //                                                       overflow: TextOverflow.ellipsis,
    //                                                       maxLines: 2,
    //                                                     ),
    ...
    //                                                 decoration:
    //                                                     BoxDecoration(color: Palette.white, borderRadius: BorderRadius.circular(10)),
    //                                                 child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ListTile(
                                ...
                                title: Text(
                                  getTranslated(context, call_history)
                                      .toString(),
                                  style: TextStyle(
                                    fontSize: width * 0.04,
                                    color: Palette.dark_blue,
