...
import 'package:doctro/Chat/utilities.dart';
...
import 'package:doctro/Firebasemodels/user_chat.dart';
import 'package:doctro/Chat/chatPage.dart';
                  ...
                  builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                    if (snapshot.hasData) {
                      if ((snapshot.data?.docs.length ?? 0) > 0) {
                        ...
                        return ChatPage(peerId: userChat.id, peerAvatar: userChat.photoUrl, peerNickname: userChat.nickname,
                        );
                      } else {
                        return Center(
                          child: Text(getTranslated(context, something_went_wrong_toast).toString(),
