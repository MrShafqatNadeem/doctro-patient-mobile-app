...
class _SignInState extends State<SignIn> {
  ...
  Future<BaseModel<Login>> callForLogin() async {
   await getOneSingleToken(SharedPreferenceHelper.getString(Preferences.patientAppId));

     Fluttertoast.showToast(msg: 'Device Token is $deviceToken', toastLength: Toast.LENGTH_SHORT, gravity: ToastGravity.BOTTOM);
